...
const adminSaved = { ...edited, schemaVersion: 7, company: 'Admin edited brand', phone: 'Admin edited phone', email: 'admin-edited@example.test' };
...
assert.equal(legacyNews.schemaVersion, 7);
